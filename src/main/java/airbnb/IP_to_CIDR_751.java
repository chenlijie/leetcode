...
public class IP_to_CIDR_751 {
    ...
    public static void main(String[] args) {
        IP_to_CIDR_751 ip = new IP_to_CIDR_751();
        ip.ipToCIDR("255.0.0.7", 10);


        System.out.println(6&(-6));
//        String[] ips = "255.0.0.7".split("\\.");
//        for (String s : ips) {
//            System.out.print(Integer.toBinaryString(Integer.parseInt(s)));
//        }
//        System.out.println();
//        System.out.println(Long.toBinaryString(4278190087l));
    }
}
